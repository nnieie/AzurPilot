...
class ConnectionAttr:
    ...
    def serial_check(self):
        ...
        if self.is_over_http:
            if self.config.Emulator_ScreenshotMethod not in ["ADB", "uiautomator2", "aScreenCap", "usb_capture"] \
                ...
                logger.warning(
                    ...
                    f'ScreenshotMethod can only use ["ADB", "uiautomator2", "aScreenCap", "usb_capture"], '
